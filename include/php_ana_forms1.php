						  ...
						  <div class="form-group">
							   ...
							   <label for="cars" style="color: white;">Select Dish: </label>
			                    <select name="select_dish" id="cars">
			                      ...
			                      ?>
			                      <option value="<?php echo $row10['dish_name'] ?>" ><?php echo $row10['dish_name']; ?></option>
			                     <?php } ?>
			                    </select><br>
...
<!-- SELECT sum(quantity) as quantity1, sum(total_raw) as total_raw2, sum(price) as price2, sum(profit) as profit2 FROM cust_order WHERE selected_dish='samosa' AND order_date BETWEEN '2020-01-20' AND '2020-12-23' -->
				...
				<table class="table" >
				  <thead class="thead-dark" >
				    <tr>
				      <th scope="col"><center>Parameter</center></th>
				      <th scope="col"><center>Output in Rs</center></th>
				      
				    </tr>
				  </thead>
				  <tbody>
				    <tr style="background-color: rgba(0, 0, 0, 0.5); color: white;">
				      <th scope="row"><center>Total num of order</center></th>
				    <?php
				    ...
				    <tr style="background-color: rgba(0, 0, 0, 0.5); color: white;">
				      ...
				      <td><center><?php echo $row['total_raw2']; ?></center></td>
				    ...
				    <tr style="background-color: rgba(0, 0, 0, 0.5); color: white;">
				      ...
				      <td><center><?php echo $row['price2']; ?></center></td>
				    
				    </tr>
				    <tr style="background-color: rgba(0, 0, 0, 0.5); color: white;">
				      <th scope="row"><center>Total Profit</center></th>
				    
				      <td><center><?php echo $row['profit2']; ?></center></td>
				    </tr> 
