...
<div class="form_div">
<form method="post" action="php_code.php" class ="form" style="padding: 15px; border: black solid; "

>
<div >
		<center><div   style="   padding-bottom: 2%; color: white;"><h3>Delete user:</h3></div>
			
            <label style="color: white;" >Enter Id</label>
            <input type="text" name="cust_id" /><br><br>
       		
			<div style="padding-bottom: 2%; ">
				<button class="button" type="submit" name="del" >delete user</button></button></div><br><br><br>
		</center>	
</div>
</div>
</form>
