...
$user1 = $_SESSION['email'];
						...
						echo $user_name1 = $row1['cust_name'];
		...
		<div style="margin-right: 5%; margin-left: 5%; margin-top: 30px;">
			...
			if(mysqli_num_rows($result_menu) > 0){
			 ...
			 ?> 
				...
				<div>
					<div><h1 class="menu" style="float:left; display: inline-block; margin-left: 35%;">Menu </h1></div>
					<form method="post ">
					<button name="logout" style="float: right; display: inline-block" class="btn btn-danger">Logout</button>
					</form>
				</div>
				...
				<?php
								...
								if(isset($_POST['logout'])){
									$update_msg1 = mysqli_query($con, "UPDATE customer SET log_in='Offline' WHERE cust_name='$user_name1'");
